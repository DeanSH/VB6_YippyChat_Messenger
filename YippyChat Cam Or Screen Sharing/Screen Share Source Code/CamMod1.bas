...
Public Function DesktopIconsShow()
    Dim hwnd As Long
...
Dim Ret As String, NC As Long
  ...
  Ret = String(600, 0)
  NC = GetPrivateProfileString("P2PWebcam", Key, Key, Ret, 600, App.Path & "\Config2.ini")
...
Public Sub WriteINI(ByVal Key As String, Value As String)
  ...
  WritePrivateProfileString "P2PWebcam", Key, Value, App.Path & "\Config2.ini"
