...
Public PingC(0 To 200) As Long
Public PingC2(0 To 200) As Long
Public TString(1 To 20) As String
Public TIndex(1 To 20) As Integer
Public PingCC As Long
Public TCount As Long
Public LogIP(0 To 200) As String, LogPort(0 To 200) As String, LogCount(0 To 200) As Integer
...
Public Function RandomGen(rChars As String, rCount As Integer) As String
